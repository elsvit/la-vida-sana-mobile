...
import { usersSlice, IStateUsers } from './users';
...
const usersPersistConfig: PersistConfig<IStateUsers> = {
  key: EStateName.users,
  storage,
  stateReconciler: autoMergeLevel2,
  whitelist: ['entities'],
};
...
const usersReducer = IS_WEB
  ? usersSlice.reducer
  : persistReducer<IStateUsers>(usersPersistConfig, usersSlice.reducer);
